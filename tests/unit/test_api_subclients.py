...
class TestProjectsAPI:
    ...
    def test_update(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/projects/42"
        )
...
class TestDatasetsAPI:
    def test_list(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/datasets"
        )

    def test_get(self, client: MammothClient):
        client.datasets.get(dataset_id=500)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/datasets/500"
        )

    def test_create(self, client: MammothClient):
        client.datasets.create(dataset_spec={"name": "ds"}, ds_creation_type="file")
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/datasets"
        )

    def test_update(self, client: MammothClient):
        client.datasets.update(dataset_id=500, patch_data={"name": "renamed"})
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/datasets/500"
        )

    def test_delete(self, client: MammothClient):
        client.datasets.delete(dataset_id=500)
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/datasets/500"
        )

    def test_browse(self, client: MammothClient):
        client.datasets.browse(dataset_id=500)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/datasets/500/browse"
        )

    def test_list_batches(self, client: MammothClient):
        client.datasets.list_batches(dataset_id=500)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/datasets/500/batches"
        )

    def test_get_batch(self, client: MammothClient):
        client.datasets.get_batch(dataset_id=500, batch_id=10)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/batches/10"
        )
    ...
    def test_bulk_update(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/datasets"
        )

    def test_bulk_delete(self, client: MammothClient):
        client.datasets.bulk_delete()
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/datasets"
        )
...
class TestDataviewsAPI:
    ...
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/dataviews/42"
        )
    ...
    def test_update(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/dataviews/42"
        )

    def test_delete(self, client: MammothClient):
        client.dataviews.delete(dataset_id=500, dataview_id=42)
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/dataviews/42"
        )
    ...
    def test_query_data(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/dataviews/42/data"
        )
...
class TestPipelineAPI:
    ...
    def test_draft_mode(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/draft-mode"
        )
...
class TestFilesAPI:
    def test_list(self, client: MammothClient):
        ...
        client.files.list()
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/files"
        )
    ...
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/files/10"
        )

    def test_delete(self, client: MammothClient):
        client.files.delete(file_id=10)
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/files/10"
        )

    def test_bulk_delete(self, client: MammothClient):
        client.files.bulk_delete(file_ids=[10, 11])
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/files"
        )
...
class TestFoldersAPI:
    def test_list(self, client: MammothClient):
        client.folders.list()
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/folders"
        )

    def test_create(self, client: MammothClient):
        client._request_json.return_value = {
            "id": 1, "name": "Test", "resource_id": "r1"
        }
        client.folders.create(name="Test Folder")
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/folders"
        )

    def test_delete(self, client: MammothClient):
        client.folders.delete(folder_ids=[1, 2])
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/folders"
        )

    def test_move(self, client: MammothClient):
        client.folders.move(
            resource_ids=["r1"], target_folder_resource_id="r2"
        )
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/folders"
        )
...
class TestExportsAPILowLevel:
    def test_list(self, client: MammothClient):
        ...
        client._request_json.return_value = {
            "exports": [], "total": 0, "limit": 50, "offset": 0, "next": "",
        }
        client.exports.list(dataview_id=42)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/pipeline/exports"
        )
...
class TestConnectorsAPI:
    def test_list(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/connectors"
        )
    ...
    def test_list_connections(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/connectors/salesforce/connections"
        )

    def test_create_connection(self, client: MammothClient):
        client.connectors.create_connection(
            connector_key="salesforce", config={"host": "x"}
        )
        assert_called_with_method_and_endpoint(
    ...
    def test_get_connection(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/connections/conn1"
        )
    ...
    def test_update_connection(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/connections/conn1"
        )
    ...
    def test_delete_connection(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/connections/conn1"
        )
    ...
    def test_list_ds_configs(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/connections/conn1/ds_configs"
        )
    ...
    def test_get_ds_config(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/ds_configs/dsc1"
        )
    ...
    def test_update_ds_config(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/ds_configs/dsc1"
        )
...
class TestSchedulesAPI:
    ...
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/schedules/5"
        )
...
class TestBatchesAPI:
    ...
    def test_delete(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/batches/10"
        )
...
class TestBrowseAPI:
    def test_workspaces(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/workspaces"
        )

    def test_projects(self, client: MammothClient):
        client.browse.projects()
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/projects"
        )
...
class TestClientAppsAPI:
    def test_list(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/clientapps"
        )
    ...
    def test_create(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/clientapps"
        )
    ...
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/clientapps/ck1"
        )

    def test_delete(self, client: MammothClient):
        client.client_apps.delete(client_key="ck1")
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/clientapps/ck1"
        )
...
class TestExternalKeysAPI:
    def test_list(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/external_keys"
        )

    def test_get(self, client: MammothClient):
        client.external_keys.get(key_id=3)
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/external_keys/3"
        )

    def test_create(self, client: MammothClient):
        client.external_keys.create(config={"name": "key1"})
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/external_keys"
        )

    def test_delete(self, client: MammothClient):
        client.external_keys.delete(key_id=3)
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/external_keys/3"
        )
...
class TestActivityLogsAPI:
    def test_list(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/activity_log"
        )

    def test_export(self, client: MammothClient):
        client.activity_logs.export()
        assert_called_with_method_and_endpoint(
            client._request_json, "POST", "/activity_log/export"
        )
...
class TestReportsAPI:
    def test_list(self, client: MammothClient):
        client.reports.list()
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/reports"
        )
...
class TestUserProfileAPI:
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/self"
        )

    def test_update(self, client: MammothClient):
        client.user_profile.update(first_name="Alice")
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/self"
        )
...
class TestWorkspaceAPI:
    ...
    def test_get(self, client: MammothClient):
        ...
        assert_called_with_method_and_endpoint(
            client._request_json, "GET", "/workspaces/1"
        )

    def test_update(self, client: MammothClient):
        client.workspaces.update(config={"name": "New WS Name"})
        assert_called_with_method_and_endpoint(
            client._request_json, "PATCH", "/workspaces/1"
        )

    def test_delete(self, client: MammothClient):
        client.workspaces.delete()
        assert_called_with_method_and_endpoint(
            client._request_json, "DELETE", "/workspaces/1"
        )
