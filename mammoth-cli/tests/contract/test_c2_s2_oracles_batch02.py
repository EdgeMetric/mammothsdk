...
CASES = [
    ...
    {"route":"dataset.rename","argv":["dataset","rename","763"],"project":41,"input":{"name":"C2_DATASET_RENAMED"},"api":DatasetsAPI,"method":"rename","kwargs":{"dataset_id":763,"name":"C2_DATASET_RENAMED","project_id":41},"wire":["PATCH","/workspaces/4/projects/41/datasets",{"json":{"patch":[{"op":"rename_dataset","path":"/763","value":{"name":"C2_DATASET_RENAMED"}}]}}],"response":{}},
    ...
    {"route":"project.bulk-update","argv":["project","bulk-update"],"input":{"patch_data":{"patch":[{"op":"replace","path":"/color","value":"#abc123"}]}},"yes":True,"api":ProjectsAPI,"method":"bulk_update","kwargs":{"patch_data":{"patch":[{"op":"replace","path":"/color","value":"#abc123"}]}},"wire":["PATCH","/workspaces/4/projects",{"json":{"patch":[{"op":"replace","path":"/color","value":"#abc123"}]}}],"response":{}},
