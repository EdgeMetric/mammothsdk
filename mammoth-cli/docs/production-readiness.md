...
Last updated 2026-09-24 (mammoth-cli 2.0.32, mammoth-io 0.7.14).
...
| Each release runs the unit + contract + realcode suites once (4394 passed at 2.0.32), ruff, mypy strict, and three `--check`-clean generators | commit messages; `docs/release-status.md` |
