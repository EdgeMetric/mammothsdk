...
Status on release: ran once on CLI 2.0.11 — Read-only sweep 2026-09-18: exit 0 on release with CLI 2.0.11; result keys: notifications. Single read only; no fixture variants, error envelopes, or write paths assessed.
