...
Example: `mammoth schema find 'view transform' --output json --no-input`. Placeholders are illustrative; resolve IDs and input from observed reads.
...
Example: `mammoth schema get view.transform.bulk-replace --output json --no-input`. Placeholders are illustrative; resolve IDs and input from observed reads.
...
Example: `mammoth schema list --output json --no-input`. Placeholders are illustrative; resolve IDs and input from observed reads.
