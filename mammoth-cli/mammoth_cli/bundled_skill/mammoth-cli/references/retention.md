...
| **Intermediate** | A child view, batch, task, job, or staging resource needed to build or verify another result. | Keep until you verify the dependent result; delete children before parents, only within the authorized scope. |
...
**retained deliverable** before creating intermediates. Carry its ID/path
...
cleanup ownership. It is not a durable cleanup journal. It does not transfer
