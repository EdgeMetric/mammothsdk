...
Copy-paste prompt for a shell-capable agent (fill `PROJECT NAME` and `TASK`;
it installs the CLI and walks you through the one-time login; the long form with the reasoning is in
