...
**Version 0.2.3** | Python 3.10+ | [PyPI](https://pypi.org/project/mammoth-io/) | [GitHub](https://github.com/EdgeMetric/mm-pysdk)
...
```bash
pip install mammoth-io==0.2.3
```

Or with Poetry:

```bash
poetry add mammoth-io==0.2.3
```
